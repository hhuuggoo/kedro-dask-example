...
# kedro_dask_example documentation build
...
from kedro_dask_example import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_dask_example"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_dask_exampledoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_dask_example.tex",
        "kedro_dask_example Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_dask_example",
        "Project kedro_dask_example codebase.",
        "Data-Science",
    )
]
